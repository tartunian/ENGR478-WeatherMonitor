...
void ssd1306PrintPic(const uint8_t *picBitmap,
  ...
  ssd1306Write(COMMAND, SSD1306_MEMORYMODE);
  ssd1306Write(COMMAND, SSD1306_MEMORY_HORIZONTAL_MODE);  // pic created are in hor mode
...
//
// This function begins overwriting at the start of the LED if the number of pixels goes past the end.
//
